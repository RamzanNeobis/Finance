...
import kotlinx.android.synthetic.main.fragment_consumption.agentSpinner
import kotlinx.android.synthetic.main.fragment_consumption.categorySpinner
import kotlinx.android.synthetic.main.fragment_consumption.date
import kotlinx.android.synthetic.main.fragment_consumption.fromAccountSpinner
import kotlinx.android.synthetic.main.fragment_consumption.projectSpinner
...
class ConsumptionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        val textDate = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.sss").format(System.currentTimeMillis())
...
//        Toast.makeText(requireContext(), dateTransaction, Toast.LENGTH_SHORT).show()
        ...
        fromAccountAdapter = ArrayAdapter<String>(requireContext(),R.layout.dropdown_menu_popup_item,
            arrayListOf())
        categoryAdapter = ArrayAdapter<String>(requireContext(),R.layout.dropdown_menu_popup_item,
            arrayListOf())
        agentAdapter = ArrayAdapter<String>(requireContext(), R.layout.dropdown_menu_popup_item, arrayListOf())
        projectNameAdapter = ArrayAdapter<String>(requireContext(),R.layout.dropdown_menu_popup_item,
            arrayListOf())
